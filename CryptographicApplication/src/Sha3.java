...
//        Arrays.fill(this.st_b, (byte)0);
//        // fixed for SHAKE256 (for SHA128 it would be 16)
//        this.mdlen = 32;
//        this.rsiz = SIZE - 2*mdlen;
//        this.pt = 0;
//
...
//            SHAKE256_update(prefix, prefix.length);
//        }
//    }
//
//    // Initialize the KMACXOF256 sponge.
//    public void KMACXOF256_init(byte[] K, byte[] S) {
//        // Validity Conditions: len(K) < 2^2040 and len(S) < 2^2040
//        byte[] encK = bytepad(encode_string(K), 136);
//        cSHAKE256_init(KMAC_N, S);
//        this.kmac = true;
//        SHAKE256_update(encK, encK.length);
//    }
//
//
//
...
//        Sha3 sha = new Sha3();
//        sha.cSHAKE256_init(N, S);
//        sha.SHAKE256_update(X, X.length);
//        sha.SHAKE256_xof();
//        sha.SHAKE_out(val, L >>> 3);
